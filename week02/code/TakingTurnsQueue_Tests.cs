...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue() was adding people at index 0
    ...
    // Defect(s) Found: Same as in the first test — PersonQueue.Enqueue() was adding people at index 0.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: TakingTurnsQueue.GetNextPerson() was not tracking a starting value of "0" as infinite turns.
    ...
    // Defect(s) Found: TakingTurnsQueue.GetNextPerson() was not tracking a starting negative value as infinite turns.
