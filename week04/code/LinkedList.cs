...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveTail()
    {
        ...
        {
            _tail.Prev!.Next = null; // Disconnect the last node from the previous node
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // For any other location of 'value', need to remove it 
                // and reconnect the Prev and Next links
                else
                {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            // If it matches, replace with the new value
